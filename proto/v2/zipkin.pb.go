...
func (Span_Kind) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{0, 0} }
...
func (*Annotation) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2} }
...
func (*ListOfSpans) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{3} }
...
func init() { proto.RegisterFile("proto/v2/zipkin.proto", fileDescriptor0) }
